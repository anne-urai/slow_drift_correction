...
class HierarchicalAutoRegressiveObservations(AutoRegressiveObservations):
    """
    ...
    def log_likelihoods(self, data, input, mask, tag):
        return self.per_group_ar_models[self.tags_to_indices[tag]].log_likelihoods(data, input, mask, tag)
