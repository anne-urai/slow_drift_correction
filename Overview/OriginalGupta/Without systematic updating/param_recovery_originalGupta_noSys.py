...
pdf = matplotlib.backends.backend_pdf.PdfPages("param_recovery_originalGupta_estimated_slowdrifts_noSys.pdf")
...
df_plot.to_csv("param_recovery_originalGupta_noSys.csv")
