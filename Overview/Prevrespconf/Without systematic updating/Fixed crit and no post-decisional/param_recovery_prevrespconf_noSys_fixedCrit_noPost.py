...
pdf = matplotlib.backends.backend_pdf.PdfPages("param_recovery_prevrespconf_noSys_estimated.pdf")
...
df_plot.to_csv("prevrespconf_noSys_noPostDecisionalfixedConfCrit.csv")
