...
pdf = matplotlib.backends.backend_pdf.PdfPages("param_recovery_prevrespconf_noSys_estimated_slowdrifts.pdf")
...
df_plot.to_csv("param_recovery_prevrespconf_noSys.csv")
