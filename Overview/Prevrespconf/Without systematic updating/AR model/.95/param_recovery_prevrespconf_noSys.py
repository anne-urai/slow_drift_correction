...
import model_fitAR, simulate_choices2 #contains the fitting funcs
...
pdf = matplotlib.backends.backend_pdf.PdfPages("param_recovery_AR_prevrespconf_noSys_95_estimated_slowdrifts.pdf")
...
for dataset in range(n_datasets):
    ...
    for ntrials_lvl in ntrial:
        ...
        # simulate dataset
        inputs, choices, drift = simulate_choices2.simulateChoice_normalEvi_slowdriftConf(estimateUpdating = True,
...
df_plot.to_csv("param_recovery_prevrespconf_AR_95_noSys.csv")
