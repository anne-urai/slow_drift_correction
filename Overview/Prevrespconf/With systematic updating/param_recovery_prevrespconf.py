...
pdf = matplotlib.backends.backend_pdf.PdfPages("param_recovery_prevrespconf_estimated_slowdrifts.pdf")
...
for dataset in range(n_datasets):
    ...
    for ntrials_lvl in ntrial:
        ...
        # simulate dataset
        inputs, choices, drift = simulate_choices.simulateChoice_normalEvi_slowdriftConf(ntrials = ntrials_lvl,
                                                                 sens = sens,
                                                                 bias = bias,
                                                                 σd = sigma_d,
...
df_plot.to_csv("param_recovery_prevrespconf.csv")
